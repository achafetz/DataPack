...
* generate
	...
	gen pmtct_art_already_T = fy2017_targets if indicator=="PMTCT_ART" & disaggregate=="MaternalRegimenType2017" & otherdisaggregate=="Life-long ART Already" & numeratordenom=="N"
	...
	gen pmtct_art_curr_T = fy2017_targets if indicator=="PMTCT_ART" & disaggregate=="MaternalRegimenType2017" & otherdisaggregate=="Life-long ART New" & numeratordenom=="N"
	gen pmtct_eid = fy2016apr if indicator=="PMTCT_EID" & disaggregate=="Total Numerator" & numeratordenom=="N"
	gen pmtct_eid_T = fy2017_targets if indicator=="PMTCT_EID" & disaggregate=="InfantTest" & numeratordenom=="N"
	...
	gen tx_new_u1_T = fy2017_targets if indicator=="TX_NEW" & disaggregate=="AgeLessThanTen" & age=="<01" & numeratordenom=="N"
