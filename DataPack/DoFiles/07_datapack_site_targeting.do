...
* gen vars for distro tabs (see 01_datapack_outputs)
	...
	gen pmtct_arv = fy2016apr if indicator=="PMTCT_ARV" & disaggregate=="MaternalRegimenType"& inlist(otherdisaggregate, "Life-long ART New", "Life-long ART Already", "Triple-drug ARV") & numeratordenom=="N"
	...
	gen kp_prev = fy2016apr if indicator=="KP_PREV" & disaggregate=="Total Numerator" & numeratordenom=="N"
...
*clean up
	...
	order operatingunit psnuuid psnu fcm_uid mechanismid indicatortype
	sort operatingunit psnu mechanismid fcm_uid indicatortype	
