...
## GENERATE VARIABLES/COLUMNS -------------------------------------------------------------------------------------
  ...
  # updated 11/9
    ...
    mutate(
      ...
      hts_tst_neg_indexmod_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="IndexMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_mobilemod_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="MobileMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_vctmod_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VCTMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_othermod_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="OtherMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_index_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Index" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_sti_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="STI" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_inpat_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Inpat" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_emergency_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Emergency" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_vct_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VCT" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_tbclinic_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="TBClinic" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_vmmc_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VMMC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_pmtctanc_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="PMTCT ANC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_pediatric_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Pediatric" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_malnutrition_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Malnutrition" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_otherpitc_u15 = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="OtherPITC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_indexmod_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="IndexMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_mobilemod_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="MobileMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_vctmod_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VCTMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_othermod_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="OtherMod" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_index_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Index" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_sti_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="STI" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_inpat_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Inpat" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_emergency_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Emergency" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_vct_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VCT" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_tbclinic_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="TBClinic" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_vmmc_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="VMMC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_pmtctanc_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="PMTCT ANC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_pediatric_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Pediatric" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_malnutrition_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="Malnutrition" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_otherpitc_u15 = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate %in% c("Modality/AgeAboveTen/Sex/Result", "Modality/AgeLessThanTen/Result") & age %in% c("<01", "01-09", "10-14") & modality=="OtherPITC" & numeratordenom=="N"), fy2017apr, 0), 
