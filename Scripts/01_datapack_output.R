...
## GENERATE VARIABLES/COLUMNS -------------------------------------------------------------------------------------
  ...
  # updated 11/7
    ...
    mutate(
      ...
      hts_tst_neg_sti = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="STI" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_neg_emergency = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Emergency" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_neg_pmtctanc = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="PMTCT ANC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_pediatric = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Pediatric" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_neg_malnutrition = ifelse((indicator=="HTS_TST_NEG" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Malnutrition" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_pos_sti = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="STI" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_pos_emergency = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Emergency" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_pos_pmtctanc = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="PMTCT ANC" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_pediatric = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Pediatric" & numeratordenom=="N"), fy2017apr, 0), 
      hts_tst_pos_malnutrition = ifelse((indicator=="HTS_TST_POS" & standardizeddisaggregate=="Modality/MostCompleteAgeDisagg" & modality=="Malnutrition" & numeratordenom=="N"), fy2017apr, 0), 
      ...
      hts_tst_kp = ifelse((indicator=="HTS_TST" & standardizeddisaggregate=="KeyPop/Result"), fy2017apr, 0), 
      hts_tst_kp_T = ifelse((indicator=="HTS_TST" & standardizeddisaggregate=="KeyPop/Result"), fy2018_targets, 0), 
      ...
      ovc_serv_spd_tot_pos_T = ifelse((indicator=="OVC_SERV" & standardizeddisaggregate=="Age/Sex/Service" & otherdisaggregate=="Social Protection" & numeratordenom=="N"), fy2018_targets, 0), 
